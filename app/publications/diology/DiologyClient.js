...
import {staticData} from '../../../data/pubPages/diologyData'
...
export default function Diology() {
    ...
    return (
        <>
            <Meta title="Design System for E-commerce" />
            <div className='kongaWapper' >
                ...
                <div className='kongaContentInfo'>
                    ...
                    <div className='DSexplained'>
                        ...
                        <div className='DSexplainedAsset'>
                          <img src={kongaData[1].image } alt="img" width="1416" height="1368"/>
                    ...
                    <div className='sectionHolderDescription'>
                        ...
                        <img className='img1' src={kongaData[2].image1} alt="img" width="1800" height="412"/>
                        <p> {kongaData[2].para1 } </p>

                        <h3>Simple Example with Konga's Header Component</h3>
                        <img className='img2' src={kongaData[2].image2} alt="img" width="3564" height="804"/>
                        <p> {kongaData[2].para2 } </p>
                        <h3>Extracted Atomic elements from header component</h3>
                        <img className='img2' src={kongaData[2].image3} alt="img" width="3564" height="488"/>
                    ...
                    <div className='sectionHolderDescription'>
                        ...
                        <img className='img1' src={kongaData[3].image} alt="img" width="1730" height="777"/>
                        <video loop="true" autoplay="autoplay" width="1760" height="600" muted>
                ...
                <div className='project01Button'>
                    ...
                    <Link href='#atomicDesign'> Atomic Design </Link>
                    <Link href='#component'> Building Components </Link>
                    <Link href='#designSystem'> Design System </Link>
                    <Link href='#mockups'> High Fidelity MockUps </Link>
                </div>
                </div>
